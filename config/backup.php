...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             */
            'compression_method' => 0, // No compression for max compatibility
         ...
         */
    'password' => null, // No password for max compatibility
         ...
         */
    'encryption' => 'default', // Let Spatie handle encryption logic
