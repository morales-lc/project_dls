                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn btn-outline-pink btn-sm view-btn" data-bs-toggle="modal" data-bs-target="#pdfModal{{ $doc->id }}"><i class="bi bi-file-earmark-pdf"></i> View</button>
                                        @auth
                                            @php
