...
<body>
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                    ...
                    <div class="view-toggle">
                        ...
                        <button type="button" class="btn btn-outline-secondary btn-sm" id="list-view-btn-undergrad">
                        ...
                        <div class="tag-discovery-card">
                            <div class="d-flex justify-content-between align-items-start flex-wrap gap-2">
                                <div>
                                    ...
                                    <div class="small text-muted">Spot relevant undergraduate papers quickly by combining tags.</div>
                                </div>
                                <button type="button" class="btn tag-toggle-btn" id="toggleTagSearchUndergrad"><i class="bi bi-tags"></i> Hide Tag Search</button>
                            </div>
                            <div id="tagFilterBoxUndergrad" class="tag-filter-box">
                                <input type="text" id="tagInputUndergrad" class="form-control" list="undergradTagSuggestions" placeholder="Type a tag and press Enter">
                                <datalist id="undergradTagSuggestions">
                                    @foreach(($tagSuggestions ?? []) as $suggestion)
                                        <option value="{{ $suggestion }}"></option>
                                    @endforeach
                                </datalist>
                                <div class="small text-muted mt-2 mb-1">Suggested tags:</div>
                                <div class="suggested-tags" id="suggestedTagsUndergrad">
                                ...
                                <input type="hidden" name="tags" id="hiddenTagsUndergrad" value="{{ isset($tagFilters) ? implode(',', $tagFilters) : request('tags', '') }}">
                                <div id="selectedTagsUndergrad" class="mt-2"></div>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var gridBtn = document.getElementById('grid-view-btn-undergrad');
            var listBtn = document.getElementById('list-view-btn-undergrad');
            var container = document.getElementById('undergrad-results');
        ...
        (function() {
            var toggleBtn = document.getElementById('toggleTagSearchUndergrad');
            var tagBox = document.getElementById('tagFilterBoxUndergrad');
            var tagInput = document.getElementById('tagInputUndergrad');
            var selectedTagsEl = document.getElementById('selectedTagsUndergrad');
            var suggestedTagsEl = document.getElementById('suggestedTagsUndergrad');
            var hiddenTags = document.getElementById('hiddenTagsUndergrad');
            var tagList = [];
