    ...
    <div class="container py-5">
        <div class="card shadow-lg w-100 border-0" style="max-width:1100px; margin:auto;">
            ...
            <div class="card-body">
                ...
                <form class="row g-2 mb-4 filter-shell" method="GET" action="" id="facultyFilterForm">
                    <div class="col-md-6">
                ...
                @if($documents->count())
                <div id="faculty-results" class="row g-4 grid-view results-container">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="card h-100 shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="small mb-2"><span class="text-muted">Type:</span> {{ $doc->type ?? 'Faculty/Theses/Dissertations' }}</div>
